export type SignUpStackParamList = {
    ...
    PasswordPage: {firstName: string; lastName: string; username: string; profileImage:string | null; gender: string; dateOfBirth: Date; email: string,city:string, latitude: number, longitude: number,category:string,career:string,bio:string,experience:string , verificationStatus:boolean};
