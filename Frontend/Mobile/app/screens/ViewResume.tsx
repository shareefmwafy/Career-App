    ...
    <SafeAreaView>
      ...
      <View style={styles.secondPartContainer}>
        ...
        <Text style={styles.careerObjectiveDescriptionStyle}>
          I want to contribute to an organization up to me the highest limit of
          my knowledge and skills with my devotion sincerity and hard working to
          add value to that organization and potentials can be explored for
          enhancing good name for that organization.
        </Text>
      </View>
